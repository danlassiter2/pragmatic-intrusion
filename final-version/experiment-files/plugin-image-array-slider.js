var jsPsychImageArraySliderResponse = (function (jspsych) {
  'use strict';

  const info = {
      name: "image-array-slider-response",
      parameters: {
   ...
   */
  class ImageArraySliderResponsePlugin {
      constructor(jsPsych) {
  ...
  ImageArraySliderResponsePlugin.info = info;

  return ImageArraySliderResponsePlugin;
