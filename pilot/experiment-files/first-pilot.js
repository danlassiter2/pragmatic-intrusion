...
var jsPsych = initJsPsych({
    on_finish: function () {
        ...
        // want to add something to make it save participant id to this as well if using
        ...
        jsPsych.data.displayData("csv"); } // just to see that the ID is in the data - REMOVE before piloting 
});
...
var target_content_types = jsPsych.randomization.repeat(["con", "arc", "ana", "def_ex", "def_un", "only"], 5); // only dg 2 while testing
...
var consent_screen = {
    ...
    \
    <p style='text-align:left'> <b>Compensation.</b> You will be paid [&pound;12/hr average, precise amount will be determined based on internal piloting] \
    for your participation in this study.</p> \
    \
