...
/* VR
NOTE: in my case, the experiment code is in a folder called experiment-files.
Currently there is a folder inside that which is named trial_list, and the csv file is there.
Although if there is going to be only one csv stim list, then don't need that folder;
if so, make sure to change the code on line 23 to reflect this
*/
...
async function read_trial_list(triallist_filename) {
  var full_filename = "trial_list/" + triallist_filename;
