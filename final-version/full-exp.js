...
function save_pragdep_data_line(data) {
    ...
    var data_to_save = [
        ...
        data.trial_index, // not in trial.data object ... 
...
var target_content_types = jsPsych.randomization.repeat(content_types, 2); 
...
var consent_screen = {
    ...
    questions about your experience (e.g. language background). Your responses will be recorded. Your session should last for around 5-6 minutes. \
